			...
			<tr class="tribe-tickets-meta-row">
				<td colspan="4" class="tribe-tickets-attendees">
					...
					<table class="tribe-tickets-table">
						...
						<tr class="js-tribe-tickets-order_status-row tribe-tickets-order_status-row">
							<td>
				...
				<td colspan="4" class="add-to-cart">
					...
					<?php else: ?>
						<button
							...
							value="1"
							class="tribe-button js-tribe-button--rsvp tribe-button--rsvp"
						>
							YES I'M COMING
						</button>
                    ...
                    <button
                            ...
                            name="tickets_process"
                            value="1"
                            class="js-tribe-button--no-rsvp tribe-button--no-rsvp"
                    >
                        NO I'M NOT COMING
                    </button>
					<?php endif; ?>
